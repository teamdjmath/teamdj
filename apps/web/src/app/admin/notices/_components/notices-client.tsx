...
▶타임테이블, 난이도, 과제 안내까지|이 반의 자세한 수업 안내는 아래 블로그 글에서 확인하실 수 있어요.|https://blog.naver.com/example/1234|블로그에서 확인하기`,
  },
  {
    key: 'examPrep',
    label: '표·강조 (시간표)',
    content: `#26년 2학기 중간 내신대비 운영기간 & 시간표

==오는 9월 17일 목요일부터 내신대비가 시작됩니다.== 시간을 확인해주세요.

|날짜|요일|시작시간|종료시간|
|9월 17일|목요일|17:00|22:00|
|9월 18일|금요일|17:00|22:00|
|9월 19일|토요일|9:00|22:00|
|9월 20일|일요일|12:00|19:00|

☞ 참여를 신청한 학생은 본래 수업시간 외에도 운영되는 모든 내신대비 시간에 자유롭게 등원할 수 있습니다.`,
  },
] as const
...
const GUIDE_SYNTAX = [
  ...
  { syntax: '|셀1|셀2|셀3|  (연속된 줄)', effect: '표 — 첫 줄이 헤더, 그 다음 줄부터 내용 행' },
  { syntax: '==강조할 텍스트==', effect: '노란 형광펜 강조 (문장 중간에도 사용 가능)' },
