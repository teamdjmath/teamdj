                ...
                {scores.map((s, i) => (
                  ...
                  >
                    ...
                    <View style={styles.scoreRight}>
                      <Text style={styles.scoreVal}>{s.score}점</Text>
                      {s.totalQ != null && (
                        <Text style={styles.scoreMeta}>{s.totalQ}문항</Text>
                      )}
                      {s.difficulty && (
...
const styles = StyleSheet.create({
  ...
  scoreRowBorder: { borderBottomWidth: 1, borderBottomColor: '#f1f1f4' },
  scoreDate: { fontSize: 13, color: '#71717a', flex: 1 },
  scoreRight: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  scoreVal: { fontSize: 15, fontWeight: '700', color: '#09090b' },
  scoreMeta: { fontSize: 12, color: '#a1a1aa' },
  diffBadge: {
    backgroundColor: '#e4e4e7', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 3,
  },
  diffText: { fontSize: 11, fontWeight: '600', color: '#52525b' },
})
